  ...
  <div class="w-full min-w-0">
    ...
    <div class="flex gap-2 min-w-0 w-full">
      <select
        ...
        class="h-11 w-[5.75rem] shrink-0 rounded-lg border border-slate-300 bg-white px-2 text-sm focus:border-brand-500 focus:ring-2 focus:ring-brand-200"
      >
      ...
      <input
        ...
        class="flex-1 min-w-0 h-11 px-3 rounded-lg border border-slate-300 focus:border-brand-500 focus:ring-2 focus:ring-brand-200 outline-none"
